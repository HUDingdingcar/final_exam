...
ret.onclick = function () {
    location.href = '../../person-home/person.html'
}
...
li[1].onclick = function () {
    location.href = '../account/edit-account.html';
    li.style.color = 'black';
    li.style.backgroundColor = '#fff';
...
but.onclick =async function () {
    ...
    location.href='/web/winter-work/personal information/person-home/person.html'
