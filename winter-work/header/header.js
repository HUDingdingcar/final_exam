...
h_li[2].onclick=function(){
    location.href='/web/winter-work/class/class-home/class-home-all/class-home.html'
}
...
h_person.onclick=function(){
    location.href='/web/winter-work/personal information/person-home/person.html?id='+localStorage.getItem('myself_id');
}
...
h_search_logo.onclick=function(){  
        location.href='/web/winter-work/search/search.html?content='+ h_search_content.value
        h_search_content.value=' '
}